return function(h, sat, val)
    ...
    local function getRed(v)
        ...
        return math.floor((r + r2) * 255)
    end
    
    local function getGreen(v)
        local g, g2 = 0, 0
        ...
        return math.floor((g + g2) * 255) - 255
    end
    
    local function getBlue(v)
        local b, b2 = 0, 0
        ...
        return math.floor((b + b2) * 255) - 255
    end
    ...
    return mix(sat, val, getRed(hue), getGreen(hue), getBlue(hue))
end
